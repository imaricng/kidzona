...
export function sistemskeUpute(): string {
  ...
  return [
    ...
    "datum i početak proslave, igraonica, paket, broj djece (bez slavljenika), ime i prezime roditelja, e-pošta, broj telefona, ime slavljenika i njegov datum rođenja.",
    "Svih devet je obvezno — bez ijednog upit se ne može poslati. Datum rođenja traži prirodno, npr. „Kad je slavljenik rođen? Zapisujemo za našu evidenciju.“",
    "Neobvezno: tema, dodaci, napomene (npr. alergije).",
    "",
